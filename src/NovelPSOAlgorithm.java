...
public class NovelPSOAlgorithm {
	...
	public NovelPSOAlgorithm(DemandPrediction problem, double swarmSize, double inertia, double cognitiveCoefficient, double socialCoefficient, double[][] problemBounds, int terminationCondition) {
